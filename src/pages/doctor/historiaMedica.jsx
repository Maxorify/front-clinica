      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-900 dark:text-blue-100 mt-1">{pacientes.length}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-900 dark:text-green-100 mt-1">{historialConsultas.length}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-700 dark:text-purple-300">Recetas Emitidas</p>
                <p className="text-3xl font-bold text-purple-900 dark:text-purple-100 mt-1">
                  {historialConsultas.filter(c => c.recetas && c.recetas.length > 0).length}
                </p>
              </div>
