...
export default function HistoriaMedica() {
  ...
  // Datos de ejemplo
  const pacientes = [
    { id: 1, nombre: 'Mar�a Gonz�lez', cedula: '1234567890', edad: 35 },
    { id: 2, nombre: 'Juan P�rez', cedula: '0987654321', edad: 42 },
    { id: 3, nombre: 'Ana L�pez', cedula: '1122334455', edad: 28 },
      ...
      consultas: [
        {
          ...
          observaciones: 'Paciente presenta mejor�a. Continuar con tratamiento actual.',
        ...
        },
        {
          ...
          sintomas: 'Ninguno',
          diagnostico: 'Hipertensi�n arterial en tratamiento',
          tratamiento: 'Losart�n 50mg cada 12 horas',
          observaciones: 'Valores de presi�n arterial estables.',
      ...
      examenes: [
        {
          id: 1,
          fecha: '2024-10-20',
          tipo: 'Ex�menes de sangre',
          descripcion: 'Perfil lip�dico completo',
          resultado: 'Normal',
          observaciones: 'Colesterol: 180 mg/dL, Triglic�ridos: 120 mg/dL'
        },
        {
          id: 2,
          fecha: '2024-09-10',
      ...
      recetas: [
        {
          ...
          fecha: '2024-10-28',
          medicamentos: [
            { nombre: 'Losart�n', dosis: '50mg', frecuencia: 'Cada 12 horas', duracion: '30 d�as' },
            { nombre: '�cido acetilsalic�lico', dosis: '100mg', frecuencia: 'Una vez al d�a', duracion: '30 d�as' }
          ]
        }
      ],
      vacunas: [
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Historia M�dica</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-2">Consulta el historial m�dico de tus pacientes</p>
      </div>
              ...
              {filteredPacientes.map((paciente) => (
                ...
                >
                  ...
                  <p className={`text-sm ${
                    ...
                    CI: {paciente.cedula} - {paciente.edad} a�os
                  </p>
                </button>
              ))}
            </div>
          ...
          {!selectedPaciente ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-12 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Selecciona un paciente de la lista para ver su historia m�dica
              </p>
            </div>
          ) : (
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-br from-green-500 to-green-600">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-white">
                    ...
                    <p className="text-green-100">CI: {selectedPaciente.cedula} - {selectedPaciente.edad} a�os</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-b border-gray-200 dark:border-gray-700">
                <div className="flex overflow-x-auto">
                  {[
                    ...
                    { id: 'examenes', label: 'Ex�menes', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
                    ...
                    {historiaActual.consultas.map((consulta) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          <span className="font-medium">Diagn�stico:</span> {consulta.diagnostico}
                        </p>
                      </div>
                    ))}
                  </div>
                          ...
                          {receta.medicamentos.map((med, idx) => (
                            <div key={idx} className="p-3 bg-white dark:bg-gray-800 rounded-lg">
                              ...
                              <div className="grid grid-cols-3 gap-2 mt-1 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <div>
                                  <span className="font-medium">Duraci�n:</span> {med.duracion}
                                </div>
                              </div>
                            </div>
                          ))}
                        ...
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                              �ltima dosis: {new Date(vacuna.fecha).toLocaleDateString('es-ES')}
                            </p>
                            {vacuna.proximaDosis && (
                              <p className="text-sm text-green-600 dark:text-green-400 mt-1">
                                Pr�xima dosis: {new Date(vacuna.proximaDosis).toLocaleDateString('es-ES')}
                              </p>
                            )}
                          </div>
        ...
        {showConsultaModal && selectedConsulta && (
          <div className="fixed inset-0 bg-gray-900/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <p className="text-sm text-gray-600 dark:text-gray-400">Presi�n Arterial</p>
              ...
              {/* S�ntomas */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">S�ntomas</h3>
              ...
              {/* Diagn�stico */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Diagn�stico</h3>
                <p className="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
