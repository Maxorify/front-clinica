...
export default function HistoriaMedica() {
  ...
  const { data: historialConsultas = [], isLoading: loadingHistorial } =
    useQuery({
                  ...
                  <div className="p-12 lg:p-20 text-center h-full flex items-center justify-center">
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Elige un paciente de la lista para visualizar su
                        historial médico completo y registros clínicos
                      </p>
                    </div>
                  </div>
                ) : (
                        ...
                        <div className="flex-1">
                          <h2 className="text-2xl lg:text-3xl font-bold text-white mb-1">
                            {selectedConsulta.informacion_consulta
                              ?.motivo_consulta || "Detalle de Consulta"}
                          </h2>
                        ...
                        selectedConsulta.recetas.length > 0 && (
                          <div>
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <button
                                onClick={() =>
                                  handleGenerarReceta(selectedConsulta)
                                }
