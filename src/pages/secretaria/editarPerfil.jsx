...
export default function EditarPerfil() {
  ...
  const handleCancel = () => {
    setIsEditing(false);
    // Aqu� podr�as restaurar los datos originales si los tienes guardados
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Gestiona tu informaci�n personal</p>
        </div>
        {!isEditing && (
          <button
