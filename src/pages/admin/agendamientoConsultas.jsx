...
export default function AgendamientoConsultas() {
  ...
  const cargarHorariosDisponibles = async () => {
    try {
      ...
      console.log(
        "DEBUG Frontend - Fecha inicio UTC:",
  ...
  const crearCita = async () => {
    try {
      ...
      console.log(
        "DEBUG - Creando cita para fecha Chile:",
        formData.fecha,
        formData.hora
      );
  ...
  const editarCita = async () => {
    try {
      ...
      console.log(
        "DEBUG - Editando cita para fecha Chile:",
        editFormData.fecha,
        editFormData.hora
      );
            ...
            >
              <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Paciente: {formatearNombreCompleto(selectedCita.paciente)} |
                  Doctor: {formatearNombreCompleto(selectedCita.doctor)}
                </p>
              </div>
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Actualizar Motivo de Consulta (opcional)
                    </label>
                    <textarea
                      rows="3"
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                  <p className="text-xs text-blue-800 dark:text-blue-300">
                    ℹ️ Solo puede seleccionar horarios disponibles del doctor.
                    Si no ve el horario deseado, primero debe crear bloques de
                    horario para ese día.
                  </p>
                </div>
              </div>
              <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-4">
