...
export default function Especialidades() {
  ...
  const especialidadesPorPagina = 6;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        ...
        await axios.put(
          `${API_URL}/doctores/modificar-especialidad/${editingId}`,
          formData
        );
      ...
      showNotification(
        "error",
        error.response?.data?.detail || "Error al guardar especialidad"
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async (id, nombre) => {
    ...
    try {
      ...
      showNotification(
        "error",
        error.response?.data?.detail || "Error al eliminar especialidad"
      );
    }
  };
  ...
  // Paginación
  const indexUltimaEspecialidad = paginaActual * especialidadesPorPagina;
  const indexPrimeraEspecialidad =
    indexUltimaEspecialidad - especialidadesPorPagina;
  const especialidadesPaginadas = filteredEspecialidades.slice(
    indexPrimeraEspecialidad,
    indexUltimaEspecialidad
  );
  const totalPaginas = Math.ceil(
    filteredEspecialidades.length / especialidadesPorPagina
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="space-y-8">
            ...
            >
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-2 font-medium">
                  Gestión de especialidades de la clínica
                </p>
              </div>
              <motion.button
            ...
            >
              ...
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="relative bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-lg p-6 text-white overflow-hidden group"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/0 to-white/10 opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className="relative flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-4xl font-bold mt-2">
                      {especialidadesPaginadas.length}
                    </p>
                  </div>
                  <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center">
                    <svg
            ...
            >
              {especialidadesPaginadas.map((especialidad, index) => (
                <motion.div
                  ...
                  className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all"
                >
                  ...
                  <div className="flex gap-2 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <motion.button
                      ...
                      className="flex-1 px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg transition-all text-sm font-bold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() =>
                        handleDelete(especialidad.id, especialidad.nombre)
                      }
                      className="flex-1 px-3 py-2 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-lg transition-all text-sm font-bold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
            ...
            {/* Paginación */}
            {filteredEspecialidades.length > 0 && totalPaginas > 1 && (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <motion.button
                  ...
                  className="px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-300 dark:border-gray-600 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-md"
                >
                  <svg
                  ...
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-lg font-semibold transition-all shadow-md ${
                      paginaActual === index + 1
                        ...
                        : "bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
                    }`}
                  >
                    {index + 1}
                  </motion.button>
            ...
            {filteredEspecialidades.length === 0 && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.3 }}
                className="text-center py-12 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700"
              >
                <svg
        ...
        {showModal && (
          <div className="fixed inset-0 bg-gray-900/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <motion.div
              ...
              className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl max-w-2xl w-full"
            >
              <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-t-2xl">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-4 top-2.5 text-gray-500 dark:text-gray-400 font-medium">
                      $
                    </span>
                    <input
                      type="number"
                ...
                <div className="flex justify-end gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={cerrarModal}
                    className="px-6 py-3 bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-400 dark:hover:bg-gray-500 transition-colors font-bold"
                  >
                    Cancelar
                  </motion.button>
                  <motion.button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl transition-all font-bold shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {loading && (
                      <svg
