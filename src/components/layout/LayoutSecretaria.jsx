              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-3">
                    <img
                      src={currentUser ? `https://ui-avatars.com/api/?name=${encodeURIComponent(currentUser.nombre || 'Secretaria')}&background=f59e0b&color=fff` : "https://ui-avatars.com/api/?name=Secretaria&background=f59e0b&color=fff"}
                      alt="Avatar"
                      className="w-10 h-10 rounded-full"
                    />
                    <div className="hidden md:block">
                      <p className="text-sm font-medium text-gray-700 dark:text-gray-200">
                        {currentUser?.nombre || 'Secretaria'}
                      </p>
